...
class Profile extends Controller {
  ...
  function admin_index() {
	  ...
	  $body['bookings'] = $this->M_bookings->Get(NULL, $this->school_id);
	  $body['periods'] = $this->M_bookings->GetPeriod();
	  $body['reservations'] = $this->M_reservations->Get(NULL, $this->school_id);
	  $body['users'] = $this->M_users->GetAll();
	  $body['rooms'] = $this->M_rooms->GetRooms();
	  $body['types'] = $this->M_rooms->GetType();
	  $body['items'] = $this->M_items->GetAll();
	  $body['item_groups'] = $this->M_items->GetItemGroup();
	  // Set main layout
	  $layout['title'] = 'Admin Approval Index';
	  $layout['showtitle'] = 'Administrator Approval Table';
	  $layout['body'] = $this->load->view('profile/profile_admin', $body, True);
	  $this->load->view('index_layout', $layout );
  ...
  function notification() {
	  ...
	  $body['bookings'] = $this->M_bookings->GetNotification($user_id);
	  $body['periods'] = $this->M_bookings->GetPeriod();
	  $body['reservations'] = $this->M_reservations->GetNotification($user_id);
	  $body['users'] = $this->M_users->GetAll();
	  $body['rooms'] = $this->M_rooms->GetRooms();
	  $body['types'] = $this->M_rooms->GetType();
	  $body['items'] = $this->M_items->GetAll();
	  ...
	  $layout['showtitle'] = 'Notifications';
	  $layout['body'] = $this->load->view('profile/profile_notification', $body, True);
	  $this->load->view('index_layout', $layout );

  }
  
  function admin_index_item() {
	  ...
	  $layout['title'] = 'Admin Approval Index';
	  $layout['showtitle'] = 'Administrator Approval Table';
	  $layout['body'] = $this->load->view('profile/profile_admin_reservations', $body, True);
	  $this->load->view('index_layout', $layout );
