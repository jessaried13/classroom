...
class Rooms_model extends Model{
  ...
  function GetType($school_id = NULL){
	...
	function GetHistoryAll() {
		...
		$query_str = "SELECT * FROM bookings WHERE status=1 ";
	...
	*/
    ...
    $this->db->update('rooms', array('active' => '0')); 
	}
