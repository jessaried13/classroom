...
<?php
$icondata[0] = array('items/fields/add', 'Add Field', 'add.gif' );
$icondata[1] = array('items', 'Items', 'school_manage_items.gif' );
...
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="sort-table" id="jsst-roomfields">
	...
	<tr class="tr<?php echo ($i & 1) ?>">
		...
		<td width="45" class="n"><?php
			$actions['edit'] = 'items/fields/edit/'.$field->field_id;
			$actions['delete'] = 'items/fields/delete/'.$field->field_id;
	...
	<?php $i++; }
		...
		echo '<td colspan="4" align="center" style="padding:16px 0">No item fields exist!</td>';
	}
	?>
	</tbody>
</table>
