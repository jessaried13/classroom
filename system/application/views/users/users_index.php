...
?>
<table width="100%" cellpadding="2" cellspacing="2" border="0" class="table table-striped table-bordered sort-table" id="jsst-users">
	<col /><col /><col /><col />
	<thead>
	<tr class="heading">
	...
	<tr class="tr<?php echo ($i & 1) ?>">
		...
		<td width="45" class="n"><?php
			...
			$this->load->view('partials/edit', $actions);
			?>
		</td>
	</tr>
	<?php $i++; } } ?>
